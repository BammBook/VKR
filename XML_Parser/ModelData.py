...
class ModelData:
    def __init__(self, filename: str):
        ...
        data = xml.dom.minidom.parse("C:/Study/VKR/PyResearch/model_data/model_parameters/" + filename + ".xml")

        # data = xml.dom.minidom.parse('C:\Study\VKR\PyResearch\model_data\model_parameters\Model220.xml')
