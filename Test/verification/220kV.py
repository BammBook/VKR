...
'model_data/model_parameters/Model220.xml'
...
data = DataClass("csv", "220kV_new/", "220_BTN1phaseA0(B180C180)", tau=tau, time_duration=time_duration)
print(data.Imax_A)
compare_max(data_time=data.time,
            data_max_time=data.Imax_A_time[:len(data.Imax_A_relative_time_partial)],
...
#
# compare_max(data_time=data.time,
#             data_max_time=data.Imax_B_time[:len(data.Imax_B_relative_time_partial)],
...
#
# compare_max(data_time=data.time,
#             data_max_time=data.Imax_C_time[:len(data.Imax_C_relative_time_partial)],
