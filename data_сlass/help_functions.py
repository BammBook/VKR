...
Ttau = np.array([0.000, 0.250, 0.500, 0.750, 1.000, 1.250, 1.500, 1.750, 2.000, 2.250, 2.500, 2.750, 3.000, 3.250, 3.500, 3.750,
        4.000, 4.250, 4.500, 4.750, 5.000])
C_b_1_cold = np.array([1.100, 0.967, 0.866, 0.790, 0.726, 0.675, 0.629, 0.585, 0.550, 0.517, 0.488, 0.462, 0.437, 0.413, 0.392,
              0.371, 0.351, 0.340, 0.323, 0.307, 0.290])
C_b_1_hot = np.array([0.78, 0.68, 0.62, 0.57, 0.53, 0.49, 0.46, 0.43, 0.41, 0.38, 0.36, 0.34, 0.325, 0.305, 0.285, 0.27, 0.255, 0.24, 0.23, 0.22, 0.21])
C_b_2_cold = np.array([0.81, 0.74, 0.67, 0.62, 0.57, 0.54, 0.51, 0.48, 0.455, 0.43, 0.41, 0.39, 0.37, 0.36, 0.35, 0.34, 0.33, 0.32, 0.31, 0.305, 0.295])
C_b_2_hot = np.array([0.57, 0.53, 0.49, 0.46, 0.43, 0.41, 0.39, 0.37, 0.355, 0.34, 0.33, 0.32, 0.305, 0.295, 0.28, 0.27, 0.26, 0.25, 0.242, 0.235, 0.23])
C_b_1_1_cold = np.array([1.87, 1.43, 1.18, 0.92, 0.74, 0.6, 0.51, 0.44, 0.38, 0.34, 0.28, 0.24, 0.2, 0.18, 0.15, 0.12, 0.11, 0.1, 0.095, 0.09, 0.08])
C_b_1_1_hot = np.array([0.68, 0.54, 0.42, 0.34, 0.25, 0.21, 0.18, 0.15, 0.12, 0.11, 0.10, 0.09, 0.08, 0.07, 0.06, 0.05, 0.04, 0.038, 0.037, 0.036, 0.035])
